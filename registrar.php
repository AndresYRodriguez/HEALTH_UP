...
if (isset($_POST['Registrarse'])) {
  if (strlen($_POST['Nombres']) >= 1 && strlen($_POST['Apellidos']) >= 1 && strlen($_POST['Genero']) >= 1 && strlen($_POST['Fecha_nacimiento']) >= 1 && strlen($_POST['Correo']) >= 1 && strlen($_POST['Contraseña']) >= 1) {
    ...
    $consulta = "INSERT INTO usuario(Nombres, Apellidos, Tipo_usuario, Id_genero, Fecha_nacimiento, Correo, Contraseña) VALUES ('$Nombres','$Apellidos','user','$Genero','$Fecha_nacimiento','$Correo','$Contraseña')";
