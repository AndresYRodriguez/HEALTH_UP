...
$TitleEnc = mysqli_query($con, "SELECT*FROM preguntas");
...
if (isset($_POST['CreateOption'])) {
    if (strlen($_POST['Valor']) >= 1) {
        ...
        $sql = "INSERT INTO opciones(Id_pregunta, Valor) VALUES('$Id_pregunta','$Valor')";
        $resul = mysqli_query($con, $sql);
        if ($resul) {
            header('Location: ./MostrarOpciones.php');
        }
    }
}

//Mostrar opciones
$MostOptions = mysqli_query($con, "SELECT*FROM opciones");
...
<body>
    ...
    <section class="home">
        <div class="container">
            <div class="row-title">
                <div class="title">
                    <h1><a href="../encuesta.php"> Crear opciones</a></h1>
                    <h2 class="subtitle"><?php echo $Title; ?></h2>
                    <div class="button-crear">
                        <button class="hero__cta">Agregar Opciones</button>
                    </div>
                </div>
            </div>
        </div>
        <div>
            <div class="table">
                <table>
                    ...
                    <tbody>
                        <?php
                        $info = mysqli_query($con, "SELECT*FROM opciones");
                        while ($row = mysqli_fetch_array($info)) {
                        ?>
                            <tr>
                                <td class="table-tareas"><?php echo $row['Valor']; ?></td>
        ...
        <section class="modal">
            <div class="modal__container">
                ...
                <form action="" method="POST">
                    <div class="form">
                        <div class="grupo">
                            <input type="text" name="Valor" class="text formu" required><span class="barra"></span>
                            <label for="" class="text">Opciones</label>
                        </div>
                    </div>
                    <div class="buttons">
        ...
        <section class="modal2">
            <div class="modal_container">
                ...
                <form action="" method="POST">
                    <div class="form">
                        <div class="grupo">
                            <input type="text" name="Valor" class="text formu" value="<?php echo $Valor; ?>"><span class="barra"></span>
                            <label for="" class="text">Opciones</label>
                        </div>
                    </div>
                    <div class="buttons">
