    ...
    <section class="service contenedor" id="servicios">
       ...
       <div class="contenedor-servicio">
           ...
           <div class="checklist-servicio">
               <div class="service">
                   <h2 class="subtitulo">sentadilla profunda con barra</h2>
       ...
       <div class="contenedor-servicio">
           ...
           <div class="checklist-servicio">
               <div class="service">
                   <h2 class="subtitulo">Press de pierna</h2>
                   <h3 class="n-service"><span class="number">1</span> Paso</h3>
       ...
       <div class="contenedor-servicio">
           ...
           <div class="checklist-servicio">
               <div class="service">
                   <h2 class="subtitulo">hight trust</h2>
                   <h3 class="n-service"><span class="number">1</span>paso</h3>
       ...
       <div class="contenedor-servicio">
           ...
           <div class="checklist-servicio">
               <div class="service">
                   <h2 class="subtitulo">sancadas</h2>
                   <h3 class="n-service"><span class="number">1</span>paso</h3>
                   <p class="text">coge dos mancuernas,parate recto y da un paso adelante</p>
               </div>
               <div class="service">
                   <h3 class="n-service"><span class="number">2</span> paso</h3>
                   <p class="text">Dobla la pierna que esta adelante bajando lentamente y detente antes de tocar el suelo(esto con la espalda racta)</p>
               </div>
               <div class="service">
                   <h3 class="n-service"><span class="number">3</span> paso</h3>
                   <p class="text">sube el cuerpo lentamente y repite con la otra rodilla</p>
               </div>
           </div>
