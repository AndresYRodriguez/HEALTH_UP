...
if (isset($_POST['CrearEncuesta'])) {
    if (strlen($_POST['Titulo']) >= 1 && strlen($_POST['Descripcion']) >= 1 && strlen($_POST['Fecha_final'])) {
        ...
        $sql = "INSERT INTO encuestas(ID_P, Titulo, Descripcion, Estado, Fecha_inicio, Fecha_final) VALUES ('$Id_user','$Title','$Description','0','$Fecha_inicio','$Date')";
        ...
        <div class="table">
            <table>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td class="table-tareas"><a href="./views/MostrarPreguntas.php?Id_encuesta=<?php echo $Id_encuesta; ?>"><?php echo $row['Titulo']; ?></a></td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="row">
                                        <form class="" action="" method="post">
                                            <button type="submit" name="Registrarse" class="modificar atajos">Modificar</button>
                                            <a href="./delete.php?id=<?php echo $row['Id_encuesta']; ?>" class="atajos">Elliminar</a>
                                            <button type="submit" name="Starting" class="atajos">Publicar</button>
                                            <button type="submit" name="Finish" class="atajos">Finalizar</button>
                                            <button type="submit" name="Registrarse" class="atajos">VIsta Previa</button>
                                            <button type="submit" name="Registrarse" class="atajos">Resultados</button>
                                        </form>
                                    </div>
                                </div>
                            </td>
