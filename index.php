...
<head>
    ...
    <title>Acerca de Health_up</title>
</head>
...
<body>
    <header class="header" id="inicio">
        ...
        <div class="contenedor head">
            ...
            <h2 class="subtitulo" style="color: #fff;">Dejenos contribuir en su bienestar</h2>
           <a href="signin.php" class="button">
                    <span class="button__text">
                        HEALTH_UP
                    </span>
                    <img src="CSS/IMG/public/cone.png" alt="" class="button__cone">
                    <img src="CSS/IMG/public/torus.png" alt="" class="button__torus">
                    <img src="CSS/IMG/public/icosahedron.png" alt="" class="button__icosahedron">
                    <img src="CSS/IMG/public/sphere.png" alt="" class="button__sphere">
                </a>
        </div>
    </header>
    <main>
        <section class="service contenedor" id="servicios">
            ...
            <div class="contenedor-servicio">
                ...
                <div class="checklist-servicio">
                    ...
                    <div class="service">
                        <h3 class="n-service"><span class="number">3</span>Pausa activa</h3>
                        <p>Ofrecemos servicios de pausas activas para mejorar la salud de sus empreados..</p>
                    </div>
                </div>
            </div>
        </section>
